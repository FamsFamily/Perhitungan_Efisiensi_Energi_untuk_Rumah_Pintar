...
def submit_form():
    ...
    with open('D:\\0. Data Materi Sekolah Rumah-Transit\\H. Kodland\\Python Pro\\Folder\\Calculator---ind-main\\Data Permintaan Kedatangan Spesialis.txt', 'a',) as f:
        f.write('Nama: ' + name)
        f.write('\nEmail: ' + email)
        f.write('\nAlamat Rumah: ' + address)
        f.write('\nTanggal yang Dipilih: ' + date + '\n-----------------------------------------------------------------------------------------------------------------------\n')
        f.close()
